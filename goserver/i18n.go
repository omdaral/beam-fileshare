...
var msgTable = map[string][2]string{
	...
	"pass_short":        {"باسورد الهوتسبوت قصير — 8 حروف على الأقل.", "Hotspot password too short — 8+ chars."},
	"pass_bad_chars":    {"الباسورد فيه حروف غير مسموحة (سطر جديد).", "Password contains invalid characters."},
	"bad_hotspot_cred":  {"اسم الشبكة أو الباسورد غير صالح.", "Invalid network name or password."},
}
