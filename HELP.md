...
> **English?** Full guide in [README.md](README.md) — **عربي؟** الدليل الكامل في [README_AR.md](README_AR.md).
...
- iPhone: no native app — Safari → **Add to Home Screen**. Android native APK: `dist/mobile/*.apk`, build guide in `mobile/SETUP.md`.
  آيفون: بدون تطبيق — من Safari اختر Add to Home Screen. أندرويد: ملف APK في `dist/mobile/`.
